...
const faqData = [
  {
    question: 'What is the coverage included in Axen Care plans?',
    answer:
  ...
  },
  {
    ...
    answer:
      'Yes, many of our Axen Care plans include coverage for mental wellness services, including therapy sessions, counseling, and psychiatric consultations. Please check your specific plan details for more information.',
  },
  {
    question: 'Do the plans include discounts on medicines?',
    answer:
      'Absolutely! Several Axen Care plans offer discounts on prescribed medicines at our network pharmacies. This is designed to help make your healthcare more affordable.',
  },
  {
    question: 'What is the process to enroll in a plan?',
    answer:
      'Enrolling in an Axen Care plan is simple. You can visit our website, select your desired plan, fill out the online application form, and complete the payment process. Our team will then reach out to confirm your enrollment.',
  },
  {
    question: 'Are there any age restrictions for the plans?',
    answer:
      'Axen Care plans are designed to cater to a wide range of age groups. While some plans may have specific age-related features, most are available to individuals and families of all ages. Please refer to individual plan details for any restrictions.',
  },
  {
    question: 'Can I switch between plans after enrolling?',
    answer:
      'Yes, in most cases, you can switch between Axen Care plans. There might be specific terms and conditions, such as a waiting period or a small administrative fee, associated with plan changes. Contact our customer service for guidance on switching plans.',
  },
];
    ...
    <section className="bg-white py-12 md:py-20 lg:py-24 px-4 sm:px-6 lg:px-8 font-sans">
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-start">
        ...
        <div className="relative flex flex-col items-center justify-center min-h-[300px] lg:min-h-[500px] xl:min-h-[600px] p-4">
          ...
          {/* <img src="/path/to/your/image.png" alt="FAQ illustration" className="relative z-10 max-w-full h-auto object-contain" /> */}
        ...
        <div className="flex flex-col">
          <div className="mb-8">
            <h3 className="text-sm font-bold text-gray-700 uppercase tracking-wider">FAQ's</h3>
            <h2 className="text-3xl md:text-4xl font-extrabold text-teal-600 leading-tight mt-2">
              how we can support your <span className="text-green-600">healthcare journey</span>
            </h2>
          </div>
            ...
            {faqData.map((item, index) => (
              <div key={index} className="border border-gray-200 rounded-lg overflow-hidden">
                ...
                >
                  ...
                  {openIndex === index ? (
                    <MinusIcon className="h-5 w-5 text-gray-600 flex-shrink-0" />
                  ) : (
                    <PlusIcon className="h-5 w-5 text-gray-600 flex-shrink-0" />
                  )}
                </button>
                {openIndex === index && (
